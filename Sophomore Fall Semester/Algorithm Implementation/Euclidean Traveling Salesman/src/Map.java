...
public class Map extends JPanel {
  ...
  public void city(City city) {
    ...
    int intX = (int)((city.x/maxX)*width) ;
    int intY = (int)((city.y/maxY)*height) ;
  ...
  public void edge(Edge edge) {
    ...
    city1X = (int)((edge.city1.x/maxX)*width) ;
    city1Y = (int)((edge.city1.y/maxY)*height) ;
    city2X = (int)((edge.city2.x/maxX)*width) ;
    city2Y = (int)((edge.city2.y/maxY)*height) ;
